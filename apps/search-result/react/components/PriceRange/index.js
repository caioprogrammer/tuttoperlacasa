...
const PriceRange = ({ title, facets, priceRange, priceRangeLayout, scrollToTop, priceRangeToggle, openFiltersMode, lastOpenFilter, setLastOpenFilter }) => {
